      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: const [
            ...
            Tab(icon: Icon(Icons.flag_outlined, size: 20), text: 'Goal'),
            Tab(icon: Icon(Icons.people_outline, size: 20), text: 'Peers'),
            Tab(icon: Icon(Icons.insights, size: 20), text: 'Insights'),
            Tab(icon: Icon(Icons.map_outlined, size: 20), text: 'Roadmap'),
            Tab(icon: Icon(Icons.priority_high, size: 20), text: 'Priorities'),
          ],
        ),
      ),
      body: Container(
